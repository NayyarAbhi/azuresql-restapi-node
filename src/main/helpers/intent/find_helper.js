...
async function getResponse(X_Auth_Find, req, By) {
    ...
    /* getting prospectId from tbl_prospect_identifier table with the help of auth_userType and auth_sub */
    ...
    /* checking if Prospect is present in tbl_prospect_identifier table */
    if (prospectId == null) {
    ...
    let prospect = await PROSPECT_HELPER.getProspectData(prospectId);
